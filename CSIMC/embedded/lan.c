...
{
	printf ("  RS232:");
	printf ("%6u sent ", n_x1);	n_x1 = 0;
	printf ("%6u rcvd ", n_r1);	n_r1 = 0;
	printf ("%6u noisy", n_nf1);
	printf ("%6u frame", n_fe1);
	printf ("%6u ovrrn", n_nv1);
	printf ("%6u stray\n", n_si1);
	printf ("  RS485:");
	printf ("%6u sent ", n_x0);	n_x0 = 0;
	printf ("%6u rcvd ", n_r0);	n_r0 = 0;
	printf ("%6u noisy", n_nf0);
	printf ("%6u frame", n_fe0);
	printf ("%6u ovrrn", n_nv0);
	printf ("%6u stray\n", n_si0);
	printf ("Tx Pkts:");
	printf ("%6u total", n_tx);	n_tx  = 0;
	printf ("%6u 1stry", n_ta);	n_ta  = 0;
	printf ("%6u retry", n_tm);	n_tm  = 0;
	printf ("%6u fail \n", n_tf);	n_tf  = 0;
	printf ("Rx Pkts:");
	printf ("%6u total", n_rx);	n_rx  = 0;
	printf ("%6u good ", n_rg);	n_rg  = 0;
	printf ("%6u mine ", n_ru);	n_ru  = 0;
	printf ("%6u dups ", n_rd);	n_rd  = 0;
	printf ("%6u rogue\n", n_ri);	n_ri  = 0;
}
 ...
 * @(#) $RCSfile: lan.c,v $ $Date: 2003/04/15 20:46:49 $ $Revision: 1.1.1.1 $ $Name:  $
 */
