...
static void gATD0 (VType *vp) { getATD (vp, 0); }
static void gATD1 (VType *vp) { getATD (vp, 1); }
static void gATD2 (VType *vp) { getATD (vp, 2); }
static void gATD3 (VType *vp) { getATD (vp, 3); }
static void gATD4 (VType *vp) { getATD (vp, 4); }
static void gATD5 (VType *vp) { getATD (vp, 5); }
static void gATD6 (VType *vp) { getATD (vp, 6); }
static void gATD7 (VType *vp) { getATD (vp, 7); }
 ...
 * @(#) $RCSfile: var.c,v $ $Date: 2003/04/15 20:46:54 $ $Revision: 1.1.1.1 $ $Name:  $
 */
