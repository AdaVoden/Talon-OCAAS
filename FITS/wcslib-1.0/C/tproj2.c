...
*
*   $Id: tproj2.c,v 1.1.1.1 2003/04/15 20:47:00 lostairman Exp $
*---------------------------------------------------------------------------*/
...
*
*   Given:
*      prj[4]    char     Projection mnemonic.
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: tproj2.c,v $ $Date: 2003/04/15 20:47:00 $ $Revision: 1.1.1.1 $ $Name:  $"};
