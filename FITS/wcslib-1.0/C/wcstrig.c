...
*
*   $Id: wcstrig.c,v 1.1.1.1 2003/04/15 20:47:00 lostairman Exp $
*---------------------------------------------------------------------------*/
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: wcstrig.c,v $ $Date: 2003/04/15 20:47:00 $ $Revision: 1.1.1.1 $ $Name:  $"};
