...
#define FIND_LINEAR_FEATURE 1   /* 1 to enable, 0 to disable linear feature 
				 * finder within camera 
				 */
Widget toplevel_w;
...
static String fallbacks[] = {
    ...
    "Camera*background: wheat",			/* overall background */
    "Camera*fontList: -*-lucidatypewriter-bold-r-*-*-12-*-*-*-m-*-*-*",
    "Camera*foreground: #11f",			/* overall foreground */
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: main.c,v $ $Date: 2003/04/15 20:47:02 $ $Revision: 1.1.1.1 $ $Name:  $"};
