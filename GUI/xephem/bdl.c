...
static int readField P_((FILE *fp, ScanType f, int w, void *ptr, char ynot[]));
static int readRec P_((FILE *fp, double *t0, double cmx[], double cfx[],
 ...
 */
static int
readRec (fp, t0, cmx, cfx, cmy, cfy, cmz, cfz, ynot)
FILE *fp;
double *t0;
double cmx[], cfx[], cmy[];
double cfy[], cmz[], cfz[];
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: bdl.c,v $ $Date: 2003/04/15 20:47:05 $ $Revision: 1.1.1.1 $ $Name:  $"};
