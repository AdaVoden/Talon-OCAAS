...
#define	NRA	(sizeof(ra_edges)/sizeof(ra_edges[0]))
...
#define	NDEC	(sizeof(dec_edges)/sizeof(dec_edges[0]))
 ...
 */
int
cns_edges (e, ra0p, dec0p, ra1p, dec1p)
double e;
double **ra0p;
double **dec0p;
double **ra1p;
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: constel.c,v $ $Date: 2003/04/15 20:47:06 $ $Revision: 1.1.1.1 $ $Name:  $"};
