...
/* bitmaps and basic organization for skyvnew toolbar */
...
typedef struct {
    int top;			/* 1 if on top bar, else on left bar */
...
static SVTBarItem svtb[] = {
    ...
    {0, 0, NULL, smallgap_bits, 0, smallgap_width, smallgap_height, NULL, 0},
    {0, 0, "Toggle between Alt-Az and RA-Dec orientation",
	orient_bits, 0, orient_width, orient_height, svtb_orient_cb, 0},
    {0, 1, "Set Spherical projection mode",
	sph_bits, 0, sph_width, sph_height, svtb_sph_cb, 0},
    {0, 1, "Set Cylindrical projection mode",
	cyl_bits, 0, cyl_width, cyl_height, svtb_proj_cb, 0},
    {0, 1, "Flip Left/Right",
	fliplr_bits, 0, fliplr_width, fliplr_height, svtb_flip_cb, 0},
    {0, 1, "Flip Top/Bottom",
	fliptb_bits, 0, fliptb_width, fliptb_height, svtb_flip_cb,(XtPointer)1},
    {0, 0, NULL, how_bits, 0, how_width, how_height, NULL, 0},
};
...
/* create the toolbar controls in the given RowColumn widgets.
 * t is top, l is left.
 */
void
svtb_create (trc_w, lrc_w)
Widget trc_w, lrc_w;
{
	SVTBarItem *ip;
	Arg args[20];
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: skytoolbar.c,v $ $Date: 2003/04/15 20:47:16 $ $Revision: 1.1.1.1 $ $Name:  $"};
