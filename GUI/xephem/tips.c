...
wtip_init ()
{
	...
	the_fs = XLoadQueryFont (dsp, getXRes ("tipFont", "fixed"));
	if (!the_fs) {
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: tips.c,v $ $Date: 2003/04/15 20:47:20 $ $Revision: 1.1.1.1 $ $Name:  $"};
