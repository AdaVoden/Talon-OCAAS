...
# $Id: cgi-lib.pl,v 1.1.1.1 2003/04/15 20:47:39 lostairman Exp $
#
...
$cgi_lib'version = sprintf("%d.%02d", q$Revision: 1.1.1.1 $ =~ /(\d+)\.(\d+)/);
...
# @(#) $RCSfile: cgi-lib.pl,v $ $Date: 2003/04/15 20:47:39 $ $Revision: 1.1.1.1 $ $Name:  $
