...
/* draw a line from [lx,ly] to [x,y]. iff tp, draw a tickmark of halfsize
 * ticklen pixels and draw a time stamp according to tp and sp at [x,y].
...
XtPointer call;
{
	...
	/* do the work and close regardless */
	(void) do_trails (tcp);
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: trailmenu.c,v $ $Date: 2003/04/15 20:47:20 $ $Revision: 1.1.1.1 $ $Name:  $"};
