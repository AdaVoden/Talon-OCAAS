...
#define NOPTCFG (sizeof(optcfg)/sizeof(optcfg[0]))
    ...
    if(!virtual_mode) {  // NOTE: Virtual Mode ALWAYS sets isUsingScript FALSE
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: filter.c,v $ $Date: 2003/04/15 20:47:57 $ $Revision: 1.1.1.1 $ $Name:  $"};
