 ...
 *  4 Feb 00 update for 2.2.* kernerls
 */
...
#define	PC39_MINVER	1		/* minor version number */

static int pc39_io_base = 0x360;	/* base address -- insmod can override*/
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: pc39x.c,v $ $Date: 2003/04/15 20:48:10 $ $Revision: 1.1.1.1 $ $Name:  $"};
