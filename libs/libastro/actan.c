...
/* @(#) $Id: actan.c,v 1.1.1.1 2003/04/15 20:48:10 lostairman Exp $ */
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: actan.c,v $ $Date: 2003/04/15 20:48:10 $ $Revision: 1.1.1.1 $ $Name:  $"};
