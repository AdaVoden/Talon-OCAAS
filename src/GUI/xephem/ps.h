...
extern void XPSAsk P_((char *title, void (*go)()));
...
extern void XPSPixmap P_((Pixmap pm, unsigned wid, unsigned hei, Colormap cm,
    GC bggc));
 ...
 * @(#) $RCSfile: ps.h,v $ $Date: 2003/04/15 20:47:13 $ $Revision: 1.1.1.1 $ $Name:  $
 */
