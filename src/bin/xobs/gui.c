...
static void mkFrame(Widget parent_w, char *name, char *title, Widget *frame_wp,
                    Widget *form_wp);
...
void mkGUI(char *version) {
  ...
  main_w = XtVaCreateManagedWidget("MainF", xmFormWidgetClass, toplevel_w,
                                   XmNverticalSpacing, 10, XmNhorizontalSpacing,
                                   10, XmNresizePolicy, XmRESIZE_NONE, NULL);

  skymap_w = mkSky(main_w);
  XtVaSetValues(skymap_w, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment,
                XmATTACH_FORM, NULL);

  logo_w = mkLogo(main_w);
  XtVaSetValues(logo_w, XmNtopAttachment, XmATTACH_FORM, XmNrightAttachment,
                XmATTACH_FORM, NULL);

  cur_w = mkCurrent(main_w);
  XtVaSetValues(cur_w, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment,
                XmATTACH_WIDGET, XmNleftWidget, skymap_w, XmNrightAttachment,
                XmATTACH_WIDGET, XmNrightWidget, logo_w, NULL);

  hf_w = XtVaCreateManagedWidget(
      "HF", xmFormWidgetClass, main_w, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, skymap_w, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, NULL);

  cam_w = mkCamera(hf_w);
  XtVaSetValues(cam_w, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment,
                XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, NULL);

  ctrl_w = mkControl(hf_w);
  XtVaSetValues(ctrl_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET,
                XmNleftWidget, cam_w, XmNleftOffset, 10, NULL);

  scope_w = mkScope(hf_w);
  XtVaSetValues(scope_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);

  dome_w = mkDome(hf_w);
  XtVaSetValues(dome_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNrightAttachment, XmATTACH_WIDGET,
                XmNrightWidget, scope_w, XmNrightOffset, 10, NULL);

  status_w = mkStatus(hf_w);
  XtVaSetValues(status_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET,
                XmNleftWidget, ctrl_w, XmNleftOffset, 10, XmNrightAttachment,
                XmATTACH_WIDGET, XmNrightWidget, dome_w, XmNrightOffset, 10,
                NULL);

  info_w = mkInfo(main_w);
  XtVaSetValues(info_w, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, hf_w,
                XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                XmATTACH_FORM, NULL);

  msgf_w = mkMsg(main_w);
  XtVaSetValues(msgf_w, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, info_w,
                XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment,
                XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);
}
...
void fillFilterMenu() {
  ...
  XtVaGetValues(pd_w, XmNnumChildren, &numChildren, XmNchildren, &children,
                NULL);
...
void nyi() {
  query(toplevel_w, "Not yet implemented :-(", "Ok", NULL, NULL, NULL, NULL,
        NULL);
}
...
Widget mkLight(Widget p_w) {
  ...
  da_w = XtVaCreateManagedWidget("LDA", xmDrawingAreaWidgetClass, p_w, XmNwidth,
                                 LIGHTW + 8, XmNheight, LIGHTH + 8, NULL);
...
void guiSensitive(int whether) {
  static Widget *batch_wp[] = {
      &g_w[CFIPD_W],   &g_w[TSERV_W],   &g_w[TSTOW_W],   &g_w[TGOTO_W],
      &g_w[TTRACK_W],  &g_w[CFHOME_W],  &g_w[CFLIM_W],   &g_w[CTEST_W],
      &g_w[CRELOAD_W], &g_w[CAUTOF_W],  &g_w[CCALIBA_W], &g_w[CPADDLE_W],
      &g_w[CCNFOFF_W], &g_w[CCNFOFF_W], &g_w[CL1_W],     &g_w[CL2_W],
  };
  int i;
...
static void logoExpCB(Widget w, XtPointer client, XtPointer call) {
...
static Widget mkLogo(Widget main_w) {
  ...
  da_w = XtVaCreateManagedWidget("LDA", xmDrawingAreaWidgetClass, fr_w,
                                 XmNwidth, LOGODASZ, XmNheight, LOGODASZ, NULL);
  if (xpms == XpmSuccess)
...
static Widget mkCurrent(Widget main_w) {
  ...
  static Ctrl ctrls[] = {
      {""},         {"RA(J2000)"}, {"Dec(J2000)"}, {"HA"},
      {"Altitude"}, {"Azimuth"},   {"Dome Az"},
  };
  Widget fr_w, f_w;
  Widget lf_w;
  ...
  lf_w =
      XtVaCreateManagedWidget("CLF", xmFormWidgetClass, f_w, XmNtopAttachment,
  ...
  lf_w = XtVaCreateManagedWidget(
      "CCF", xmFormWidgetClass, f_w, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, lf_w, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
      XmATTACH_FORM, NULL);
  l_w[0] = XtVaCreateManagedWidget("CL", xmLabelWidgetClass, lf_w, XmNalignment,
                                   XmALIGNMENT_CENTER, NULL);
  wltprintf(prT, l_w[0], "Current");
  for (i = 1; i < XtNumber(l_w); i++) {
    l_w[i] = XtVaCreateManagedWidget(
        "CPT", xmTextFieldWidgetClass, lf_w, XmNbackground, uneditableColor,
...
static Widget mkCamera(Widget main_w) {
  ...
  tbl_w = XtVaCreateManagedWidget(
      "CRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, XmNnumColumns, 1, XmNpacking,
      XmPACK_TIGHT, NULL);

  fof_w = XtVaCreateManagedWidget("FOF", xmFormWidgetClass, tbl_w, NULL);

  g_w[CFILT_W] = mkLight(fof_w);
  XtVaSetValues(g_w[CFILT_W], XmNtopAttachment, XmATTACH_FORM,
                XmNbottomAttachment, XmATTACH_FORM, XmNrightAttachment,
                XmATTACH_FORM, XmNforeground, getColor(toplevel_w, "green"),
                NULL);

  fmb_w = mkFilterOp(fof_w);
  XtVaSetValues(fmb_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNrightAttachment, XmATTACH_WIDGET,
                XmNrightWidget, g_w[CFILT_W], XmNrightOffset, 10, NULL);
  ...
  XtVaSetValues(tf_w, XmNbackground, uneditableColor, XmNcursorPositionVisible,
                False, XmNeditable, False, XmNmaxLength, 8, XmNmarginHeight, 1,
  ...
  XtVaSetValues(l_w, XmNalignment, XmALIGNMENT_BEGINNING, NULL);
  XtVaSetValues(tf_w, XmNbackground, uneditableColor, XmNcursorPositionVisible,
                False, XmNeditable, False, XmNmarginHeight, 1, XmNmarginWidth,
                1, NULL);
  g_w[CT_W] = tf_w;
  g_w[CTLT_W] = da_w;
  ...
  lgt_w = XtVaCreateManagedWidget("Li", xmFormWidgetClass, tbl_w, NULL);

  g_w[CLLT_W] = mkLight(lgt_w);
  XtVaSetValues(g_w[CLLT_W], XmNtopAttachment, XmATTACH_FORM,
                XmNbottomAttachment, XmATTACH_FORM, XmNrightAttachment,
                XmATTACH_FORM, XmNforeground, getColor(toplevel_w, "gray"),
                NULL);
...
static Widget mkDome(Widget main_w) {
  ...
  tbl_w = XtVaCreateManagedWidget(
      "DRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, XmNisAligned, False, XmNadjustMargin,
      False, XmNpacking, XmPACK_TIGHT, XmNspacing, 2, NULL);
  ...
  w = XtVaCreateManagedWidget("C", xmSeparatorWidgetClass, tbl_w, XmNheight, 5,
  ...
  w = XtVaCreateManagedWidget(
      "A", xmToggleButtonWidgetClass, tbl_w, XmNalignment, XmALIGNMENT_CENTER,
      XmNindicatorOn, True, XmNindicatorType, XmN_OF_MANY, XmNvisibleWhenOff,
      True, XmNmarginHeight, 0, NULL);
  ...
  g_w[DAZL_W] = l_w;
  g_w[DAZ_W] = tf_w;
  XtVaSetValues(tf_w, XmNbackground, editableColor, XmNmaxLength,
                5, /* e.g. 123.5 */
                NULL);
...
static Widget mkControl(Widget main_w) {
  ...
  tbl_w = XtVaCreateManagedWidget(
      "CRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, XmNnumColumns,
      (XtNumber(ctrls) + 1) / 2, XmNadjustLast, False, XmNisAligned, False,
      XmNorientation, XmHORIZONTAL, XmNpacking, XmPACK_COLUMN, XmNspacing, 5,
      NULL);
  ...
  for (i = 0; i < XtNumber(ctrls); i++) {
    ...
    if (cp->tb) {
      w = XtVaCreateManagedWidget(
          "T", xmToggleButtonWidgetClass, tbl_w, XmNalignment,
          XmALIGNMENT_BEGINNING, XmNindicatorOn, True, XmNindicatorType,
          XmN_OF_MANY, XmNvisibleWhenOff, True, XmNmarginHeight, 0, NULL);
      if (cp->cb)
        XtAddCallback(w, XmNvalueChangedCallback, cp->cb, NULL);

    } else {
      w = XtVaCreateManagedWidget("P", xmPushButtonWidgetClass, tbl_w,
                                  XmNentryAlignment, XmALIGNMENT_CENTER,
                                  XmNmarginHeight, 0, NULL);
      if (strcmp(cp->lbl, "Stop") == 0)
        XtVaSetValues(w, XmNforeground, getColor(toplevel_w, "white"),
                      XmNbackground, getColor(toplevel_w, "red"), NULL);
      if (cp->cb)
...
static Widget mkStatus(Widget main_w) {
  ...
  static Ctrl ctrls[] = {
      {"Batch", &g_w[SBLT_W]},    {"Tracking", &g_w[STLT_W]},
      {"Slewing", &g_w[SSLT_W]},  {"Homing", &g_w[SHLT_W]},
      {"Limiting", &g_w[SLLT_W]}, {"Weather", &g_w[SWLT_W]},
      {"Confirm", &g_w[SCLT_W]},
  };
  Widget fr_w, f_w;
  Widget tbl_w;
  ...
  tbl_w = XtVaCreateManagedWidget(
      "CRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, XmNpacking, XmPACK_TIGHT, XmNspacing,
      4, NULL);
  ...
  for (i = 0; i < XtNumber(ctrls); i++) {
    ...
    lt_w = mkLight(sf_w);
    XtVaSetValues(lt_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                  XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);
    ...
    sl_w = XtVaCreateManagedWidget(
        "P", xmLabelWidgetClass, sf_w, XmNtopAttachment, XmATTACH_FORM,
        XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
        XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget, lt_w, XmNalignment,
...
static Widget mkScope(Widget main_w) {
  ...
  rrc_w = XtVaCreateManagedWidget(
      "SRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, XmNpacking, XmPACK_TIGHT, XmNspacing,
      6, NULL);
  ...
  l_w[1] = XtVaCreateManagedWidget("SSt", xmTextFieldWidgetClass, rf_w,
                                   XmNbackground, editableColor, XmNcolumns, 10,
                                   XmNmarginHeight, 1, XmNmarginWidth, 1, NULL);
  ...
  rc_w = XtVaCreateManagedWidget("CRC", xmRowColumnWidgetClass, rrc_w,
                                 XmNmarginWidth, 0, XmNnumColumns, 2,
                                 XmNpacking, XmPACK_COLUMN, NULL);

  for (i = 0; i < XtNumber(ctrls); i++) {
    mkPrompt(rc_w, 9, &lb_w, &tf_w, NULL);
    wltprintf(prT, lb_w, "%s", ctrls[i].lbl);
    XtVaSetValues(tf_w, XmNbackground, editableColor, XmNpendingDelete, False,
                  XmNmaxLength, 9, NULL);
    if (ctrls[i].tip)
...
static Widget mkMsg(Widget main_w) {
  ...
  l_w = XtVaCreateManagedWidget("L", xmPushButtonWidgetClass, f_w,
                                ...
                                e_w, XmNtopOffset, 5, XmNleftAttachment,
                                XmATTACH_OPPOSITE_WIDGET, XmNleftWidget, e_w,
                                XmNrightAttachment, XmATTACH_FORM, NULL);
  ...
  sw_w = XtParent(msg_w);
  XtVaSetValues(sw_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
                XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget, e_w,
                XmNrightOffset, 5, NULL);
  XtVaSetValues(msg_w, XmNeditMode, XmMULTI_LINE_EDIT, XmNeditable, False,
                XmNcursorPositionVisible, False, XmNrows, 10, XmNmarginHeight,
                1, XmNmarginWidth, 1, NULL);
...
static Widget mkInfo(Widget main_w) {
  ...
  lf_w =
      XtVaCreateManagedWidget("ILF", xmFormWidgetClass, f_w, XmNtopAttachment,
                              XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
                              XmNrightAttachment, XmATTACH_FORM, NULL);
  for (i = 0; i < XtNumber(l_w); i++) {
    l_w[i] = XtVaCreateManagedWidget("IL", xmLabelWidgetClass, lf_w, NULL);
    wltprintf(prT, l_w[i], "%s", ctrls[i].lbl);
  }
  mkRow(lf_w, l_w, XtNumber(l_w), 25);

  lf_w = XtVaCreateManagedWidget(
      "ILF", xmFormWidgetClass, f_w, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, lf_w, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
      XmATTACH_FORM, NULL);
  for (i = 0; i < XtNumber(l_w); i++) {
    l_w[i] = XtVaCreateManagedWidget(
        "IL", xmTextFieldWidgetClass, lf_w, XmNbackground, uneditableColor,
        XmNcolumns, 8, XmNcursorPositionVisible, False, XmNeditable, False,
        XmNmarginHeight, 1, XmNmarginWidth, 1, NULL);
    if (ctrls[i].wp)
      *ctrls[i].wp = l_w[i];
    if (ctrls[i].tip)
  ...
  sep_w = XtVaCreateManagedWidget(
      "S", xmSeparatorWidgetClass, f_w, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, lf_w, XmNtopOffset, 10, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_FORM, NULL);

  lf_w = XtVaCreateManagedWidget(
      "ILF", xmFormWidgetClass, f_w, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, sep_w, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
      XmATTACH_FORM, NULL);
  for (i = 0; i < XtNumber(l_w); i++) {
    l_w[i] = XtVaCreateManagedWidget("IL", xmLabelWidgetClass, lf_w, NULL);
...
static void mkFrame(Widget parent_w, char *name, char *title, Widget *frame_wp,
  ...
  title_w = XtVaCreateManagedWidget(
      "FL", xmLabelWidgetClass, fr_w, XmNchildType, XmFRAME_TITLE_CHILD,
      XmNchildHorizontalAlignment, XmALIGNMENT_CENTER, NULL);
  wltprintf(frT, title_w, "%s", title);

  f_w = XtVaCreateManagedWidget("FF", xmFormWidgetClass, fr_w, XmNchildType,
                                XmFRAME_WORKAREA_CHILD, NULL);
...
static void mkRow(Widget f_w, Widget w_p[], int n, int w) {
  ...
  for (i = 0; i < n; i++)
    XtVaSetValues(w_p[i], XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                  XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION,
                  XmNleftPosition, i * (w + 1), XmNrightAttachment,
                  XmATTACH_POSITION, XmNrightPosition, w + i * (w + 1), NULL);
}
...
static Widget mkPrompt(Widget p_w, int tc, Widget *l_wp, Widget *tf_wp,
  ...
  tf_w = XtVaCreateManagedWidget(
      "PTF", xmTextFieldWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
  ...
  if (lb_wp) {
    ...
    XtVaSetValues(lb_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                  XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);

    XtVaSetValues(tf_w, XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget,
                  lb_w, XmNrightOffset, 10, NULL);
  ...
  l_w = XtVaCreateManagedWidget(
      "PL", xmLabelWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
      XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
      XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget, tf_w, NULL);
...
static void drawLt(Widget wid) {
  ...
  XDrawLine(dsp, win, guigc, x - 3, y + LIGHTH + 3, x + LIGHTW + 3,
            y + LIGHTH + 3);
  XDrawLine(dsp, win, guigc, x + LIGHTW + 3, y + LIGHTH + 3, x + LIGHTW + 3,
            y - 3);
...
static Widget mkFilterOp(Widget fof_w) {
  ...
  XtVaSetValues(fmb_w, XmNmarginWidth, 0, XmNmarginHeight, 0, NULL);
  XtManageChild(fmb_w);
  ...
  XtManageChild(cb_w);
  XtVaSetValues(cb_w, XmNmarginWidth, 0, XmNmarginHeight, 0, XmNsubMenuId, pd_w,
                NULL);
  wtip(cb_w, "Current filter. To change: Press, Select from list, Release");

  /* create a label on the left */
  flbl_w = XmCreateLabel(fof_w, "FLBL", NULL, 0);
  XtVaSetValues(flbl_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
                XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, NULL);
 ...
 */
static void flatLtCB(Widget w, XtPointer client, XtPointer call) {
...
static void mkFlatLights(Widget form_w, Widget light_w) {
  ...
  l_w = XtVaCreateManagedWidget(
      "Lights", xmLabelWidgetClass, form_w, XmNtopAttachment, XmATTACH_FORM,
      XmNleftAttachment, XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM,
      XmNalignment, XmALIGNMENT_BEGINNING, NULL);

  tb2_w = XtVaCreateManagedWidget(
      "Lights", xmToggleButtonWidgetClass, form_w, XmNtopAttachment,
      XmATTACH_FORM, XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget,
      light_w, XmNrightOffset, 10, XmNbottomAttachment, XmATTACH_FORM,
      XmNalignment, XmALIGNMENT_BEGINNING, XmNindicatorOn, True,
      XmNindicatorType, XmN_OF_MANY, XmNvisibleWhenOff, True, XmNmarginHeight,
      0, NULL);
  ...
  tb1_w = XtVaCreateManagedWidget(
      "Lights", xmToggleButtonWidgetClass, form_w, XmNtopAttachment,
      XmATTACH_FORM, XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget, tb2_w,
      XmNrightOffset, 2, XmNbottomAttachment, XmATTACH_FORM, XmNalignment,
      XmALIGNMENT_BEGINNING, XmNindicatorOn, True, XmNindicatorType,
      XmN_OF_MANY, XmNvisibleWhenOff, True, XmNmarginHeight, 0, NULL);
