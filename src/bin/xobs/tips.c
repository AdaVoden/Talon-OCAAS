 ...
 */
typedef enum { T_DOWN, T_ARMED, T_UP } TState;
typedef struct {
...
int tip_geton() { return (!tip_silent); }

/* set whether we want tips */
void tip_seton(int whether) { tip_silent = !whether; }
