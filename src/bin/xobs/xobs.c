...
int main(int ac, char *av[]) {
  ...
  /* connect to X server */
  toplevel_w = XtVaAppInitialize(&app, myclass, options, XtNumber(options), &ac,
                                 av, fallbacks, XmNallowShellResize, False,
                                 XmNiconName, myclass, NULL);
...
#ifdef WANT_EDITRES
  /* support editres */
  XtAddEventHandler(toplevel_w, (EventMask)0, True, _XEditResCheckMessages,
                    NULL);
#endif /*  WANT_EDITRES */
