...
/* gui.c */
typedef enum { LTIDLE, LTOK, LTACTIVE, LTWARN, LTN } LtState;
...
/* query.c */
extern void query(Widget tw, char *msg, char *label0, char *label1,
                  char *label2, void (*func0)(), void (*func1)(),
                  void (*func2)());
 ...
 * @(#) $RCSfile: xobs.h,v $ $Date: 2003/04/15 20:47:41 $ $Revision: 1.1.1.1 $
 * $Name:  $
 */
