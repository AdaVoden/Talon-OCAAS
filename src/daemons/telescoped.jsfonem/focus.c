...
focus_offset(int first, ...)
{
	...
	//if (mip->raw == rawgoal) {
	// STO: 20010511 attempt to prevent possible rounding error (? may not exist)
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: focus.c,v $ $Date: 2003/04/15 20:47:59 $ $Revision: 1.1.1.1 $ $Name:  $"};
