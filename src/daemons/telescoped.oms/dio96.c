 ...
 */
void
dio96_ctrl (int regn, unsigned char ctrl)
{
	DIO_IOCTL dio;
...
void
dio96_getallbits (unsigned char bits[12])
{
	dio96_open();
...
static void
dio96_showbits (unsigned char bits[12])
{
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: dio96.c,v $ $Date: 2003/04/15 20:47:59 $ $Revision: 1.1.1.1 $ $Name:  $"};
