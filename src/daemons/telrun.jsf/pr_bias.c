...
//	int i;
	...
	/* build command line */
	/* FOR JSF: just send the NUMBER of bias frames, not their names
	
	l += sprintf (cmd+l, "calimagePV -B");
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: pr_bias.c,v $ $Date: 2003/04/15 20:48:01 $ $Revision: 1.1.1.1 $ $Name:  $"};
