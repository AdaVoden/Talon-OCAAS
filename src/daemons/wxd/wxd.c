...
dispense (WxStats *wp, double t, double p)
{
	...
	if (vflag) {
	    ...
	    printf ("%s Wind =%3dKPH @ %-3d  Air = %5.1fC %3d%%RH %6.1fmB Rain=%5.1fmm\n",
						wp->alert ? "ALERT" : "     ",
	...
	if (lflag &&
		...
		fprintf (logfp, "%13.5f %3d %-3d %5.1f %3d %6.1f %5.1f ",
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: wxd.c,v $ $Date: 2003/04/15 20:48:02 $ $Revision: 1.1.1.1 $ $Name:  $"};
