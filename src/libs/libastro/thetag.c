...
/* @(#) $Id: thetag.c,v 1.1.1.1 2003/04/15 20:48:13 lostairman Exp $ */
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: thetag.c,v $ $Date: 2003/04/15 20:48:13 $ $Revision: 1.1.1.1 $ $Name:  $"};
