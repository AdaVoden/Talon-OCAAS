...
extern void
fitsread(infile,inname,outfile,nx,ny,passthru,padded,nlterm)
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: fitsread.c,v $ $Date: 2003/04/15 20:48:34 $ $Revision: 1.1.1.1 $ $Name:  $"};
